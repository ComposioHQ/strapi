...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    cover: Attribute.Component<'cover.cover'>;
    guide_box: Attribute.Component<'guide-box.guide-box'>;
    tools_section: Attribute.Component<'tools-section.tools-section'>;
    video_block: Attribute.Component<'video-block.video-block'>;
    cta_section: Attribute.Component<'cta-section.cta-section'>;
    feature_block: Attribute.Component<'feature-box.feature-section', true>;
    meta_tags: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPlaygroundExamplePlaygroundExample
  extends Schema.CollectionType {
